...
import { SearchResultListItemBlueprint, SearchFilterResultTypeBlueprint, SearchFilterBlueprint } from '@backstage/plugin-search-react/alpha';
    ...
    return originalFactory({
      ...
      loader: async () => {
        ...
        const Component = () => {
          ...
          ), additionalSearchFilters.map((SearchFilterComponent) => /* @__PURE__ */ React.createElement(SearchFilterComponent, { className: classes.filter })))), /* @__PURE__ */ React.createElement(Grid, { item: true, xs: true }, /* @__PURE__ */ React.createElement(SearchPagination, null), /* @__PURE__ */ React.createElement(SearchResult, null, ({ results }) => /* @__PURE__ */ React.createElement(React.Fragment, null, results.map((result, index) => {
