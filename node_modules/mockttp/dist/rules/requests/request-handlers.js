...
async function writeResponseFromCallback(result, response) {
    ...
    if (result.body && !result.rawBody) {
        ...
        typeof result.body === 'string'
            ...
            : Buffer.from(result.body), result.headers ?? {});
    }
        ...
        return new Promise((resolve, reject) => (async () => {
            serverReq = await makeRequest({
                ...
                if (this.transformResponse) {
                    ...
                    modifiedRes = await this.beforeResponse({
                        ...
                        tags: clientReq.tags,
                        body: (0, request_utils_1.buildBodyReader)(reqBodyOverride ? Buffer.from(reqBodyOverride.buffer) : await clientReq.body.asDecodedBuffer(), reqHeader),
            ...
            function reportUpstreamAbort(e) {
                ...
                options.emitEventCallback('passthrough-abort', {
                    ...
                    tags: (0, passthrough_handling_1.buildUpstreamErrorTags)(e),
                    error: {
                        name: e.name,
                        code: e.code,
                        message: e.message,
        ...
        if (data.hasBeforeResponseCallback) {
            beforeResponse = async (res, req) => {
                const callbackResult = await channel.request('beforeResponse', {
                    args: [(0, body_serialization_1.withSerializedBodyReader)(res), (0, body_serialization_1.withSerializedBodyReader)(req)]
                });
